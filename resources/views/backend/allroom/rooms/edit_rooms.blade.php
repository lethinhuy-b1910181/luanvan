                    ...
                    {{-- =================== Start Form xử lí update Room ======================= --}}
                                            <form class="row g-3" action="{{ route('update.room',$editData->id) }}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <br>
                                                    <img id="showImage" width="70" height="70" src="{{  (!empty($editData->image)) ? url('upload/roomimg/'.$editData->image) : url('upload/no_image.jpg') }}" alt="Admin" class=" bg-primary" width="80">

                                                </div>
                                                <div class="col-md-6">
                                                    <label for="input4" class="form-label">Gallery Image</label>
                                                    <input type="file" name="multi_img[]" multiple class="form-control" id="multiImg" accept="image/jpeg, image/jpg, image/gif, image/png">
                                                    <br>
                                                    @foreach ($multiImgs as $item)
                                                        <img id="showImage" width="70" height="70" src="{{  (!empty($item->multi_img)) ? url('upload/roomimg/multi_img/'.$item->multi_img) : url('upload/no_image.jpg') }}" alt="Admin" class=" bg-primary" width="80">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="view" id="input7" class="form-select">
                                                        ...
                                                        <option value="See View" {{$editData->view == 'See View'?'selected':''}}>Sea View</option>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" name="short_desc" id="input11" placeholder="short description ..." rows="3">{{ $editData->short_desc }}</textarea>
                                                </div>
                                                <div class="col-md-12">
                                            ...
                                            <form action="{{ route('store.room.no', $editData->id) }}" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="text" class="form-control" name="room_no" id="input2"  >
                                                    ...
                                                    <div class="col-md-4">
                                                        <button type="submit" class="btn btn-success" style="margin-top: 29px">Save</button>
                                                    </div>
                                                </div>
                                            </form>
                                                ...
                                                @foreach ($allroomNo as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ route('delete.roomno', $item->id) }}" id="delete" class="btn btn-danger px-3 radius-30">Delete</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
...
<!--------=== Script xử lí thêm nhiều hình ảnh mới mà vẫn giữ lại hình ảnh đã thêm trước đó ========------->
